...
export default function InfantLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname();
  const departmentId = 'infant'; // This layout is specifically for infant
      ...
      <main className="flex flex-1 container mx-auto px-4 py-12">
        <aside className="w-1/5 pr-12 border-r border-gray-200 hidden md:block">
          <nav className="sticky top-24">
            <h2 className="text-3xl font-extrabold mb-8 text-gray-800">영아부</h2>
            <ul>
              <li className="mb-4">
